...
try {
    ...
    `java -jar ./closureJS/compiler.jar --js $build_dir/background.js --js_output_file $build_dir/background.js`;
	`java -jar ./closureJS/compiler.jar --js $build_dir/park.js --js_output_file $build_dir/park.js`;
	`java -jar ./closureJS/compiler.jar --js $build_dir/popup.js --js_output_file $build_dir/popup.js`;
	`java -jar ./closureJS/compiler.jar --js $build_dir/utils.js --js_output_file $build_dir/utils.js`;
	print STDERR "Ok\n";
    ...
    for my $file (@files) {
        if($file ne './build.pl'){
            ...
            `java -jar ./closureJS/compiler.jar --js $file --js_output_file $file`;
            print "OK\n";
        }
    }
	
	print STDERR "Check all JS syntax...\n";
    my $command = "java -jar ./closureJS/compiler.jar --js ".$build_dir."modules/*.js --js ".$build_dir."*.js --js_output_file ./tmp/dummy.js";
